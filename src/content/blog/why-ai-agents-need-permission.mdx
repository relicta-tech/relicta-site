...
>
  <div slot="before">
    ...
    flowchart TD
      ...
      style AgentA fill:#ff4444,stroke:#333,stroke-width:2px,color:#fff
    ```
  </div>
  <div slot="after">
    ```mermaid
    flowchart TD
      ...
      style AgentB fill:#4444ff,stroke:#333,stroke-width:2px,color:#fff
      style Relicta fill:#5cf0c8,stroke:#333,stroke-width:2px,color:#000
    ```
  </div>
</DiagramCompare>
