...
>
  ...
  <div slot="after">
    ...
    flowchart TD
      ...
      classDef accent fill:#5cf0c8,stroke:#333,stroke-width:2px,color:currentColor;
...
flowchart TB
    ...
    classDef accent fill:#5cf0c8,stroke:#333,stroke-width:2px,color:var(--diagram-accent-text-color);
    class PERM accent;
